...
@section('content')
    ...
    @endif
        ...
        <form class="d-flex flex-column" action="{{ route("categorias.store") }}" method="post" style="border-top: 2px solid #413f3d; padding: 20px">
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="col-4 d-flex flex-column">
                    ...
                    <input class="form-control form-control-sm" id="nombre" name="nombre" type="text" required style="width: 100%">
                </div>
            </div>
            <br>
            <div>
